...
class initwin:  # 主窗口
    def __init__(self, master):
        ...
        self.initwin = tk.Frame(
            self.master,
        )
        self.initwin.pack()
        self.canvas = tk.Canvas(self.initwin, width=1920, height=1080, bg="green")
        ...
        self.canvas.create_image(
            0, 0, anchor="nw", image=im
        )  # 使用create_image将图片添加到Canvas组件中
        ...
        self.title = tk.Label(
            self.initwin, text="肌肉组织切片扫描图像纤维细胞计量", font=("微软雅黑", 30)
        )
        self.author1 = tk.Label(
            self.initwin, text="中国农业科学院北京畜牧兽医研究所", font=("微软雅黑", 25)
        )
        self.author2 = tk.Label(
            self.initwin, text="安徽省农业科学院畜牧兽医研究所", font=("微软雅黑", 25)
        )
        self.author3 = tk.Label(
            self.initwin, text="北京林业大学", font=("微软雅黑", 25)
        )
        self.canvas.create_window(
            190, 100, anchor="nw", width=700, height=50, window=self.title
        )
...
class singlewin:
    def __init__(self, master):
        ...
        self.str = "此处输出结果信息"
        self.singlewin = tk.Frame(
            self.master,
        )
        self.singlewin.pack()
        self.canvas = tk.Canvas(self.singlewin, width=1920, height=1080, bg="white")
        ...
        self.state = tk.Message(
            self.singlewin, text=self.str, width=300, font=("微软雅黑", 12)
        )
        ...
        self.open_label_info = ttk.Label(
            self.singlewin,
            text="参考范围：1-5",
            anchor="center",
            style="label.TLabel",
        ...
        self.bgiter_label_info = ttk.Label(
            self.singlewin,
            text="参考范围：1-10",
            anchor="center",
            style="label.TLabel",
        ...
        self.area_label_info = ttk.Label(
            self.singlewin,
            text="参考范围：10-100",
            anchor="center",
            style="label.TLabel",
        ...
        self.thresholdmode_label = ttk.Label(
            self.singlewin,
            text="阈值模式",
            anchor="center",
            style="label.TLabel",
        ...
        self.thresholdmode_label_info = ttk.Label(
            self.singlewin,
            text="0-255",
            anchor="center",
            style="label.TLabel",
        ...
        self.pixel_label_info = ttk.Label(
            self.singlewin,
            text="参考值：0.273810",
            anchor="center",
            style="label.TLabel",
        ...
        self.choose_file = ttk.Button(
            self.singlewin, text="...", command=self.choose_file
        )
        self.choose_save = ttk.Button(
            self.singlewin, text="...", command=self.save_file
        )
        ...
        self.choose_open = ttk.Entry(
            self.singlewin,
            show=None,
            font=("微软雅黑", 14),
            width=20,
            textvariable=open_num,
        )
        # 选择膨胀迭代次数
        bgiter_num = tkinter.IntVar(value=3)
        self.choose_bgiter = ttk.Entry(
            self.singlewin,
            show=None,
            font=("微软雅黑", 14),
            width=20,
        ...
        self.choose_dis = ttk.Entry(
            self.singlewin,
            show=None,
            font=("微软雅黑", 14),
            width=20,
            textvariable=dis_num,
        )
        # 选择保留的最小面积
        min_area = tkinter.StringVar(value=30)
        self.choose_area = ttk.Entry(
            self.singlewin,
            show=None,
            font=("微软雅黑", 14),
            width=20,
            textvariable=min_area,
        )
        # 选择阈值模式
        thresholdmode_value = tkinter.StringVar()  # 窗体自带的文本，新建一个值
        self.choose_thresholdmode = ttk.Combobox(
            self.singlewin, font=("微软雅黑", 14), textvariable=thresholdmode_value
        )  # 初始化
        self.choose_thresholdmode["values"] = ("默认", "自定义")
        self.choose_thresholdmode.current(0)  # 选择第一个
        # 选择阈值
        threshold_value = tkinter.IntVar(value=160)
        self.choose_threshold = ttk.Entry(
            self.singlewin,
            show=None,
            font=("微软雅黑", 14),
            width=20,
        ...
        self.choose_pixel = ttk.Entry(
            self.singlewin,
            show=None,
            font=("微软雅黑", 14),
            width=20,
            textvariable=pixel_pixel,
        )

        # 选择路径
        e = tkinter.StringVar()
        e1 = tkinter.StringVar()
        self.choose_bar = tk.Entry(
            self.singlewin, show=None, font=("微软雅黑", 14), width=20, textvariable=e
        )
        self.save_bar = tk.Entry(
            self.singlewin, show=None, font=("微软雅黑", 14), width=20, textvariable=e1
        )
        ...
        self.canvas.create_window(
            420, 100, width=50, height=30, window=self.choose_file
        )
        ...
        self.canvas.create_window(
            420, 150, width=50, height=30, window=self.choose_save
        )
        # 20240102添加
        # ---------------------------------------------------------------------------------------------
        self.canvas.create_window(
            500, 200, width=200, height=30, window=self.open_label_info
        )
        self.canvas.create_window(
            500, 250, width=200, height=30, window=self.bgiter_label_info
        )
        self.canvas.create_window(
            500, 300, width=200, height=30, window=self.dis_label_info
        )
        self.canvas.create_window(
            500, 350, width=200, height=30, window=self.area_label_info
        )
        self.canvas.create_window(
            750, 400, width=100, height=30, window=self.thresholdmode_label_info
        )
        self.canvas.create_window(
            450, 450, width=200, height=30, window=self.pixel_label_info
        )
        # ---------------------------------------------------------------------------------------------
        # 按键
        ...
        self.canvas.create_window(
            600, 400, height=30, width=100, window=self.choose_threshold
        )
        self.canvas.create_window(
            260, 450, height=30, width=150, window=self.choose_pixel
        )
    ...
    def save_file(
        ...
        self.save_file = tkinter.filedialog.asksaveasfilename(
            title="选择路径"
        )  # 保存路径
    ...
    def count(
        ...
        try:
            ...
            self.canvas.create_window(
                650, 150, anchor="nw", width=300, window=self.state
            )
...
class batchwin:
    def __init__(self, master):
        ...
        self.master.config(bg="GhostWhite")
        self.str = "此处输出结果信息"
        self.batchwin = tk.Frame(
            self.master,
        )
        self.batchwin.pack()
        self.canvas = tk.Canvas(self.batchwin, width=1920, height=1080, bg="white")
        ...
        self.state = tk.Message(
            self.batchwin, text=self.str, width=300, font=("微软雅黑", 12)
        )
        self.canvas.create_window(800, 100, height=50, window=self.s_title)
        self.canvas.create_window(650, 150, anchor="nw", width=300, window=self.state)
        ...
        self.threshold_label = ttk.Label(
            self.batchwin, text="阈值", anchor="center", style="label.TLabel", width=100
        )
        self.pixel_label = ttk.Label(
            self.batchwin,
            text="像素物理尺寸",
        ...
        self.choose_file = ttk.Button(
            self.batchwin, text="...", command=self.choose_file
        )
        ...
        thresholdmode_value = tkinter.StringVar()  # 窗体自带的文本，新建一个值
        self.choose_thresholdmode = ttk.Combobox(
            self.batchwin, font=("微软雅黑", 14), textvariable=thresholdmode_value
        )  # 初始化
        self.choose_thresholdmode["values"] = ("默认", "自定义")
        self.choose_thresholdmode.current(0)  # 选择第一个
        # 选择阈值
        ...
        e1 = tkinter.StringVar()
        self.choose_bar = tk.Entry(
            self.batchwin, show=None, font=("微软雅黑", 14), width=20, textvariable=e
        )
        self.save_bar = tk.Entry(
            self.batchwin, show=None, font=("微软雅黑", 14), width=20, textvariable=e1
        )
        # 标记一下上面的东西都被创立了，下面要把它们放在画布上
        self.canvas.create_window(100, 100, width=100, window=self.choose_pic)
        self.canvas.create_window(280, 100, height=30, window=self.choose_bar)
    ...
    def count(
        ...
        self.canvas.create_window(650, 150, anchor="nw", width=300, window=self.state)
        self.open_file = tk.Button(
            self.batchwin, text="打开保存文件夹", command=self.open_file
        )
        self.canvas.create_window(
            650, 485, anchor="nw", width=150, height=30, window=self.open_file
        )
